...
class DaybookFragment @Inject constructor() : MvpAppCompatFragment(R.layout.fragment_feature_user_daybook)
    , DaybookView, Toolbar.OnMenuItemClickListener {

    @Inject
    internal lateinit var lazyPresenter: Lazy<DaybookPresenter>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            toolbarDelegate.apply {
                ...
                inflateMenu(R.menu.menu_main_screen_toolbar, this@DaybookFragment)
