...
class TestsFragment @Inject constructor() : MvpAppCompatFragment(R.layout.fragment_feature_tests)
    , TestsView, Toolbar.OnMenuItemClickListener {

    @Inject
    internal lateinit var lazyPresenter: Lazy<TestsPresenter>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            toolbarDelegate.apply {
                ...
                inflateMenu(R.menu.menu_main_screen_toolbar, this@TestsFragment)
